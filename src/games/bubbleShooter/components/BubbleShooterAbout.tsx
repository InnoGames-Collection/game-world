...
interface BubbleShooterAboutProps {
  onClose: () => void;
}

export const BubbleShooterAbout: React.FC<BubbleShooterAboutProps> = ({ onClose }) => {
  return (
    <div
      id="bubble-shooter-about-view"
    ...
    >
      ...
      <main className="relative z-10 flex-1 py-4 space-y-3.5 text-xs text-slate-300 overflow-y-auto custom-scrollbar pr-1">
        <div className="p-4 rounded-2xl bg-white/5 border border-white/10 text-center space-y-1.5">
          <div className="text-base font-black text-white uppercase">Bubble Shooter Pro Arcade</div>
