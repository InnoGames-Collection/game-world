...
interface BubbleShooterMenuProps {
...
export const BubbleShooterMenu: React.FC<BubbleShooterMenuProps> = ({
  progress,
  profile,
  currentLevelNumber,
  isAudioMuted = false,
  ...
  return (
    ...
    >
      ...
      <main className="relative z-10 my-auto py-4 flex flex-col items-center text-center max-w-md mx-auto w-full">
        {/* 3D Glossy Spheres Cluster Mascot */}
        <div className="relative mb-3 flex items-center justify-center">
          <div className="absolute -inset-4 rounded-full blur-2xl opacity-40 bg-cyan-400" />
          <div className="relative flex items-center justify-center -space-x-3 drop-shadow-2xl">
            <div className="w-12 h-12 rounded-full bg-gradient-to-br from-rose-400 via-rose-500 to-rose-700 shadow-lg border border-white/40 flex items-center justify-center transform -translate-y-1">
              <div className="w-4 h-2 rounded-full bg-white/70 blur-[0.5px] -translate-y-2 -translate-x-1 rotate-[-25deg]" />
            </div>
            <div className="w-16 h-16 rounded-full bg-gradient-to-br from-cyan-300 via-cyan-500 to-blue-700 shadow-xl border-2 border-white/60 flex items-center justify-center z-10">
              <div className="w-5 h-2.5 rounded-full bg-white/80 blur-[0.5px] -translate-y-3 -translate-x-1.5 rotate-[-25deg]" />
            </div>
            <div className="w-12 h-12 rounded-full bg-gradient-to-br from-amber-300 via-amber-500 to-amber-700 shadow-lg border border-white/40 flex items-center justify-center transform -translate-y-1">
              <div className="w-4 h-2 rounded-full bg-white/70 blur-[0.5px] -translate-y-2 -translate-x-1 rotate-[-25deg]" />
            </div>
          </div>
        </div>
