...
interface BubbleShooterAchievementsProps {
...
export const BubbleShooterAchievements: React.FC<BubbleShooterAchievementsProps> = ({
  progress,
  onClose,
}) => {
  return (
    <div
      id="bubble-shooter-achievements-view"
