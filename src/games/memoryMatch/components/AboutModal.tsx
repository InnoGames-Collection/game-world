      ...
      <div className="flex-1 min-h-0 overflow-y-auto overscroll-contain pr-1 space-y-3 py-3 text-xs leading-relaxed text-slate-300">
        <div className="bg-[#051424]/90 border border-[#0A7C45]/60 rounded-2xl p-4 space-y-2">
          <div className="flex items-center gap-2 text-[#FFD54F] font-black text-sm uppercase">
            ...
            <span>GoPlay Memory Match Championship</span>
          </div>
          <p>
            Memory Match is a flagship cognitive skill game engineered specifically for the GoPlay Ethiopia competitive gaming platform. Designed with 40 progressively calibrated levels, it challenges players to push the limits of working memory, spatial orientation, and visual discernment.
          </p>
        </div>
        ...
        <div className="text-center py-2 text-[10px] text-slate-400">
          <div>GoPlay Ethiopia Gaming Platform • v2.4.0</div>
