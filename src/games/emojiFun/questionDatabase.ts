...
export const LEVEL_CONFIGS: EmojiLevelConfig[] = [
  { level: 1, title: 'Emoji Basics', difficultyStars: 1, timeLimitSeconds: 15, targetScore: 1200, questionCount: 10, theme: 'Easy Recognition' },
  { level: 2, title: 'Happy Faces', difficultyStars: 1, timeLimitSeconds: 15, targetScore: 1250, questionCount: 10, theme: 'Smiles & Gestures' },
  { level: 3, title: 'Animal Friends', difficultyStars: 1, timeLimitSeconds: 15, targetScore: 1300, questionCount: 10, theme: 'Wild & Pets' },
  { level: 4, title: 'Tasty Treats', difficultyStars: 1, timeLimitSeconds: 15, targetScore: 1350, questionCount: 10, theme: 'Snacks & Fruits' },
  { level: 5, title: 'Simple Mix', difficultyStars: 1, timeLimitSeconds: 15, targetScore: 1400, questionCount: 10, theme: 'Basic Pairs' },
  { level: 6, title: 'Love & Hearts', difficultyStars: 2, timeLimitSeconds: 14, targetScore: 1500, questionCount: 10, theme: 'Feelings' },
  { level: 7, title: 'Emoji Pairs', difficultyStars: 2, timeLimitSeconds: 14, targetScore: 1550, questionCount: 10, theme: 'Combinations' },
  { level: 8, title: 'Guess the Meal', difficultyStars: 2, timeLimitSeconds: 14, targetScore: 1600, questionCount: 10, theme: 'Food Combos' },
  { level: 9, title: 'Daily Life', difficultyStars: 2, timeLimitSeconds: 13, targetScore: 1650, questionCount: 10, theme: 'Everyday Actions' },
  { level: 10, title: 'Movie Night I', difficultyStars: 2, timeLimitSeconds: 13, targetScore: 1700, questionCount: 10, theme: 'Famous Movies' },
  { level: 11, title: 'Odd One Out I', difficultyStars: 2, timeLimitSeconds: 13, targetScore: 1750, questionCount: 10, theme: 'Spot the Difference' },
  { level: 12, title: 'Category Clash', difficultyStars: 3, timeLimitSeconds: 12, targetScore: 1850, questionCount: 10, theme: 'Not Belonging' },
  { level: 13, title: 'Sports Center', difficultyStars: 3, timeLimitSeconds: 12, targetScore: 1900, questionCount: 10, theme: 'Games & Athletics' },
  { level: 14, title: 'Travel Clues', difficultyStars: 3, timeLimitSeconds: 12, targetScore: 1950, questionCount: 10, theme: 'Vehicles & Journeys' },
  { level: 15, title: 'World Places I', difficultyStars: 3, timeLimitSeconds: 12, targetScore: 2000, questionCount: 10, theme: 'Countries & Landmarks' },
  { level: 16, title: 'Emoji Sequence I', difficultyStars: 3, timeLimitSeconds: 11, targetScore: 2100, questionCount: 10, theme: 'Logical Patterns' },
  { level: 17, title: 'Memory Flash I', difficultyStars: 3, timeLimitSeconds: 11, targetScore: 2150, questionCount: 10, theme: 'Visual Recall' },
  { level: 18, title: 'Movie Night II', difficultyStars: 3, timeLimitSeconds: 11, targetScore: 2200, questionCount: 10, theme: 'Blockbusters' },
  { level: 19, title: 'Common Sayings', difficultyStars: 3, timeLimitSeconds: 11, targetScore: 2250, questionCount: 10, theme: 'Phrases & Idioms' },
  { level: 20, title: 'Midway Tournament', difficultyStars: 3, timeLimitSeconds: 11, targetScore: 2350, questionCount: 10, theme: 'Championship Trial' },
  { level: 21, title: 'Odd One Out II', difficultyStars: 4, timeLimitSeconds: 10, targetScore: 2450, questionCount: 10, theme: 'Micro-Differences' },
  { level: 22, title: 'Music & Songs', difficultyStars: 4, timeLimitSeconds: 10, targetScore: 2500, questionCount: 10, theme: 'Hit Titles' },
  { level: 23, title: 'Nature & Cosmos', difficultyStars: 4, timeLimitSeconds: 10, targetScore: 2550, questionCount: 10, theme: 'Planets & Earth' },
  { level: 24, title: 'Speed Round I', difficultyStars: 4, timeLimitSeconds: 10, targetScore: 2600, questionCount: 10, theme: 'Rapid Reflex' },
  { level: 25, title: 'World Places II', difficultyStars: 4, timeLimitSeconds: 10, targetScore: 2700, questionCount: 10, theme: 'Cities & Cultures' },
  { level: 26, title: 'Memory Flash II', difficultyStars: 4, timeLimitSeconds: 9, targetScore: 2800, questionCount: 10, theme: 'Multi-Symbol Recall' },
  { level: 27, title: 'Emoji Sequence II', difficultyStars: 4, timeLimitSeconds: 9, targetScore: 2850, questionCount: 10, theme: 'Evolution Cycles' },
  { level: 28, title: 'Fantasy & Magic', difficultyStars: 4, timeLimitSeconds: 9, targetScore: 2900, questionCount: 10, theme: 'Mythical Legends' },
  { level: 29, title: 'Foodies Deluxe', difficultyStars: 4, timeLimitSeconds: 9, targetScore: 2950, questionCount: 10, theme: 'Global Dishes' },
  { level: 30, title: 'Speed Round II', difficultyStars: 4, timeLimitSeconds: 9, targetScore: 3050, questionCount: 10, theme: 'Fast Deciders' },
  { level: 31, title: 'Tricky Idioms', difficultyStars: 5, timeLimitSeconds: 8, targetScore: 3200, questionCount: 10, theme: 'Abstract Phrases' },
  { level: 32, title: 'Cinema Legends', difficultyStars: 5, timeLimitSeconds: 8, targetScore: 3250, questionCount: 10, theme: 'Classic Films' },
  { level: 33, title: 'Odd One Out III', difficultyStars: 5, timeLimitSeconds: 8, targetScore: 3300, questionCount: 10, theme: 'Master Imposters' },
  { level: 34, title: 'Tech & Modern Life', difficultyStars: 5, timeLimitSeconds: 8, targetScore: 3350, questionCount: 10, theme: 'Gadgets & Apps' },
  { level: 35, title: 'Memory Grandmaster', difficultyStars: 5, timeLimitSeconds: 8, targetScore: 3400, questionCount: 10, theme: 'High-Density Recall' },
  { level: 36, title: 'Grand Combinations', difficultyStars: 5, timeLimitSeconds: 7, targetScore: 3550, questionCount: 10, theme: 'Multi-Emoji Riddles' },
  { level: 37, title: 'Global Odyssey', difficultyStars: 5, timeLimitSeconds: 7, targetScore: 3600, questionCount: 10, theme: 'Geographic Puzzles' },
  { level: 38, title: 'Sequence Mastery', difficultyStars: 5, timeLimitSeconds: 7, targetScore: 3650, questionCount: 10, theme: 'Complex Patterns' },
  { level: 39, title: 'Lightning Round', difficultyStars: 5, timeLimitSeconds: 7, targetScore: 3750, questionCount: 10, theme: 'Speed Tournament' },
  { level: 40, title: 'Tournament Championship', difficultyStars: 5, timeLimitSeconds: 7, targetScore: 3900, questionCount: 10, theme: 'Ultimate Finals' },
];
