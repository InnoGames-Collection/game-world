...
export const DEFAULT_TOURNAMENTS: Tournament[] = [
  {
    id: 'tourney_weekly_crazy_color',
    title: 'Crazy Color Grand Tournament',
    gameId: 'crazy-colors',
    gameTitle: 'Crazy Color',
    cycle: 'weekly',
    bannerImage: getGameArtworkUrl('crazy-colors'),
    prizePoolETB: 25000,
    ...
    sponsor: 'telebirr SuperApp Gaming',
    prizes: [
  ...
  {
    id: 'tourney_weekly_fruit_ninja',
    title: 'Fruit Ninja Katana Championship',
    gameId: 'fruit-slice',
    gameTitle: 'Fruit Ninja',
    cycle: 'weekly',
    bannerImage: getGameArtworkUrl('fruit-slice'),
    prizePoolETB: 20000,
  ...
  {
    id: 'tourney_weekly_helix_jump',
    title: 'Helix Jump Tower Masters',
    gameId: 'helix-jump',
    gameTitle: 'Helix Jump',
    cycle: 'weekly',
    bannerImage: getGameArtworkUrl('helix-jump'),
    prizePoolETB: 30000,
    prizePoolCoins: 120000,
    entryFeeEnergy: 0,
    entryRequirement: '2 Coins Per Play (10 ETB Pack = 5 Plays)',
    startDate: 'Monday, Aug 25',
    endDate: 'Sunday, Aug 31',
  ...
  {
    id: 'tourney_monthly_pop_piano',
    title: 'Pop Piano Grand Virtuoso Cup',
    gameId: 'pop-piano',
    gameTitle: 'Pop Piano',
    cycle: 'monthly',
    ...
    sponsor: 'EthioTelecom / telebirr Digital',
    prizes: [
