...
export const INITIAL_GAME_CATALOG: CatalogGame[] = [
  // ==========================================
  // 1. PUZZLE CATEGORY (Candy Blast, World Legends require coins per spec)
  // ==========================================
  {
    gameId: 'emoji-fun',
    gameName: 'EMOJI FUN',
  ...
  },
  {
    ...
    coinCost: 10,
    subscriptionOptions: {
      daily: { enabled: true, priceETB: 5 },
      weekly: { enabled: true, priceETB: 20 },
      monthly: { enabled: true, priceETB: 50 },
    },
    isFeatured: true,
    isRecommended: true,
    isActive: true,
  ...
  },
  {
    ...
    subscriptionOptions: {
      daily: { enabled: true, priceETB: 5 },
      monthly: { enabled: true, priceETB: 45 },
    },
    isFeatured: true,
    isRecommended: true,
    isActive: true,
...
export const GameCatalog = {
  getAll(): CatalogGame[] {
    return INITIAL_GAME_CATALOG.filter((g) => g.isActive).map((g) => {
